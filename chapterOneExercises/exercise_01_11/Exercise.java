...
public class Exercise {
    public static void main(String[] args) {
        ...
        System.out.println("Year 1 Projection: " + (312032486 + ((365 * 24 * 60 * 60) / 7) + ((365 * 24 * 60 * 60) / 45) 
        - ((365 * 24 * 60 * 60) / 13)));

        System.out.println("Year 2 Projection: " + (312032486 +
         ((((365 * 24 * 60 * 60) / 7) + ((365 * 24 * 60 * 60) / 45) - ((365 * 24 * 60 * 60) / 13)) * 2)));
         
         System.out.println("Year 3 Projection: " + (312032486 +
         ((((365 * 24 * 60 * 60) / 7) + ((365 * 24 * 60 * 60) / 45) - ((365 * 24 * 60 * 60) / 13)) * 3)));

         System.out.println("Year 4 Projection: " + (312032486 +
         ((((365 * 24 * 60 * 60) / 7) + ((365 * 24 * 60 * 60) / 45) - ((365 * 24 * 60 * 60) / 13)) * 4)));
         
         System.out.println("Year 5 Projection: " + (312032486 +
         ((((365 * 24 * 60 * 60) / 7) + ((365 * 24 * 60 * 60) / 45) - ((365 * 24 * 60 * 60) / 13)) * 5)));    
    }   
}
